    ...
    return (
        <div className="flex items-center justify-center flex-col">
            ...
            <div className={cn("text-sm md:text-xl text-neutral-400 mt-4 max-w-xs md:max-w-2xl text-center mx-auto", textFont.className)}>
                Collaborate, Manage Project and Reach new productivity peaks. From high rises to the home office, the way your team works is unique - accomplish it with Taskify.
            </div>
